     ...
     <div style="position:absolute; right:30px; top: 20px;">
          <nav class="uw-thin-strip-nav" role='navigation' aria-label='audience based'>
              <ul class="uw-thin-links">
                <li><a href="/hrp-portal/" title="Sign in to Workday"><img alt="" class="" style="width:30px;" src="<?php echo get_site_url() . '/wp-content/themes/isc-uw-child/assets/images/workday-w.png'?>"> Sign in to Workday</a></li>
