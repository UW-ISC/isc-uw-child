            ...
            <div class="col-md-5">
              ...
              <div class="col-md-6">
                <ul class="footer-contact-container">
                  ...
                  <li><div class="icon-container"><i class="fa fa-phone-square " aria-hidden="true"></i></div><div class="text-container"><a href="<?php echo "tel+01-". $options['phone'] ?>"> <?php echo $options['phone'] ?>   </a></div></li>
